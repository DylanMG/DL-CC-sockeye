...
subtitle:  |
    ...
    | Supplement 2: Calculating $S_{MAX_{PR}}$ and SDs
...
- `lake_data` is a table that was used in the analysis of 69 sockeye populations in the BioRxiv paper, which corresponds to the file `lakePR_final.txt` Brendan Connors gave me (Dylan) when I started playing with this analysis.  
