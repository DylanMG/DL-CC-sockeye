...
paste("min ESS =", min(fit1.summary$n_eff, na.rm = TRUE)/8000, "%")
...
paste("min ESS =", min(fit2a.summary$n_eff, na.rm = TRUE)//8000, "%")
#loo(fits[[2]])
#plot(loo(fits[[2]]))
...
mcmc_combo(fits[[3]], combo = c("dens_overlay", "trace"), 
           ...
           gg_theme = legend_none())
mcmc_combo(fits[[3]], combo = c("dens_overlay", "trace"), 
           pars = c("log_a_region[1]", "log_a_region[2]", "log_a_region[3]", "sd_a_region"), 
           gg_theme = legend_none()) 
fit2b.summary  <- as.data.frame(rstan::summary(fits[[3]])$summary)
paste("max R-hat =", max(fit2b.summary$Rhat, na.rm = TRUE))
paste("min ESS =", min(fit2b.summary$n_eff, na.rm = TRUE)/8000, "%")
#loo(fits[[3]])
#plot(loo(fits[[3]]))
...
paste("min ESS =", min(fit3.summary$n_eff, na.rm = TRUE)/8000, "%")
#loo(fits[[4]])
#plot(loo(fits[[4]]))
...
paste("min ESS =", min(fit4.summary$n_eff, na.rm = TRUE)/8000, "%")
#loo(fits[[5]])
#plot(loo(fits[[5]]))
...
#plot PPC
model.pars4 <- rstan::extract(fits[[5]])
logRS_rep <- model.pars4$logRS_rep
