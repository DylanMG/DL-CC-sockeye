...
paste("min ESS =", min(fit1.summary$n_eff, na.rm = TRUE)/iter, "%")
loo(fits[[1]])
plot(loo(fits[[1]]))
...
paste("min ESS =", min(fit2a.summary$n_eff, na.rm = TRUE)/iter, "%")
loo(fits[[2]])
plot(loo(fits[[2]]))
...
paste("min ESS =", min(fit2b.summary$n_eff, na.rm = TRUE)/iter, "%")
loo(fits[[3]])
plot(loo(fits[[3]]))
...
paste("min ESS =", min(fit3.summary$n_eff, na.rm = TRUE)/iter, "%")
loo(fits[[4]])
plot(loo(fits[[4]]))
...
paste("min ESS =", min(fit4a.summary$n_eff, na.rm = TRUE)/iter, "%")
loo(fits[[5]])
plot(loo(fits[[5]]))
...
paste("min ESS =", min(fit4b.summary$n_eff, na.rm = TRUE)/iter, "%")
loo(fits[[6]])
plot(loo(fits[[6]]))
