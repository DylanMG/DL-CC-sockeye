...
## Diagnostics  
Here we check if chains have mixed, the maximum **R-hat** is less than 1.05, and that the effective sample size is at least 10% of the iterations 
...
max(fit1.summary$Rhat, na.rm = TRUE)
min(fit1.summary$n_eff, na.rm = TRUE)/4000 #WHAT IS GOING ON WITH NEFF HERE!! max is more than iter
...
max(fit2a.summary$Rhat, na.rm = TRUE)
min(fit2a.summary$n_eff, na.rm = TRUE)/4000
#loo(fits[[2]])
#plot(loo(fits[[2]]))
...
max(fit2b.summary$Rhat, na.rm = TRUE)
min(fit2b.summary$n_eff, na.rm = TRUE)/4000
#loo(fits[[3]])
#plot(loo(fits[[3]]))
...
max(fit3.summary$Rhat, na.rm = TRUE)
min(fit3.summary$n_eff, na.rm = TRUE)/4000
#loo(fits[[4]])
#plot(loo(fits[[4]]))
...
max(fit4.summary$Rhat, na.rm = TRUE)
min(fit4.summary$n_eff, na.rm = TRUE)/4000
#loo(fits[[5]])
#plot(loo(fits[[5]]))
