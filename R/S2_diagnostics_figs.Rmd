...
paste("min ESS =", round((min(fit1.summary$n_eff, na.rm = TRUE)/iter)*100), "%")
loo(fits[[1]])
plot(loo(fits[[1]]))
ggplot(fit1.summary, aes(n_eff)) +
  geom_histogram() +
  geom_vline(xintercept = iter*.1, lty=2) + #could annotate a "10%" here too 
  theme_classic() +
...
paste("min ESS =", round((min(fit2a.summary$n_eff, na.rm = TRUE)/iter)*100), "%")
loo(fits[[2]])
plot(loo(fits[[2]]))
ggplot(fit2a.summary, aes(n_eff)) +
  geom_histogram() +
  geom_vline(xintercept = iter*.1, lty=2) +
  theme_classic() +
  labs(x = "effective sample size")
...
paste("min ESS =", round((min(fit2b.summary$n_eff, na.rm = TRUE)/iter)*100), "%")
loo(fits[[3]])
plot(loo(fits[[3]]))
...
paste("min ESS =", round((min(fit3.summary$n_eff, na.rm = TRUE)/iter)*100), "%")
loo(fits[[4]])
plot(loo(fits[[4]]))
...
paste("min ESS =", round((min(fit4a.summary$n_eff, na.rm = TRUE)/iter)*100), "%")
loo(fits[[5]])
plot(loo(fits[[5]]))
...
paste("min ESS =", round((min(fit4b.summary$n_eff, na.rm = TRUE)/iter)*100), "%")
loo(fits[[6]])
plot(loo(fits[[6]]))
