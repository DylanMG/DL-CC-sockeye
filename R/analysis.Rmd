...
```{r other fig, fig.width=5.62, fig.height=4.215, dpi= 300}
...
sub_log_a <- filter(log_a_draws, pop %in% c("atnarko", "owikeno", "koeye", "long", "canoona", "damdochax")) %>%
  pivot_longer(cols = c('m1_draw', 'm2b_draw'), names_to= 'draw_type', values_to = 'draw') %>%
